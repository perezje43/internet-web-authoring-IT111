...
$subject = 'Email from Jeremy\'s website'; // if your client has more than one web site, you can put the site name here.
...
mail ('perezje43@gmail.com', $subject, $body, $from);
